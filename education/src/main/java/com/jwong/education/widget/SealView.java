package com.jwong.education.widget;
...
public class SealView extends View {
    ...
    private int bigOvalWidth = 2;  // 大圆宽度

    private int smallOvalWidth = 1; // 小圆宽度

    private int bigSmallMargin = 15; //大圆小圆的间距
    ...
    public SealView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        secondTextSize = 2 * firstTextSize / 3;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float sweepAngle;
        float startAngle;
        int rString = (int) (radius * 0.6 * firstTextMarginMultiple);
